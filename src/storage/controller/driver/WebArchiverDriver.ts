import type {ArchiverDriver} from "@src/shared/interface";
...
export class WebArchiverDriver implements ArchiverDriver {
	async archive(blobs: Record<string, Blob>): Promise<Blob> {
	...
	private setCheckSum(block: Uint8Array): void {
	...
	private checkSum(block: Uint8Array, data: Data): boolean {
